    ...
    function html5Upload() {	
    	...
    	//sUploadURL= '/koarl_admin/file/multipleUpload';     //다중파일업로드 URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			//sUrl  : '/koarl_admin/file/upload', //파일업로드시 동작되는 컨트롤러 url
 			//sCallback : '/koarl_admin/resources/smarteditor/photo_uploader/popup/callback.html',  //업로드 이후  redirect 페이지 url
