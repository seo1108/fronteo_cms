...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <span class="f24">Company Brochure</span> 
          <span class="f14" style="padding-left:20px;">전체 Company Brochure</span> <span class="f14" style="color:blue;"><fmt:formatNumber value="${totalCnt}" pattern="#,###" /></span>
        </section>
        ...
        <section class="content">
        	...
        	<div class="row">
				<div class="col-xs-12">
					...
					<div>
						<button onclick="go_contents_add();" class="btn bg-primary btn-sm">등록</button>
						<button onclick="delete_contents();" class="btn btn-danger btn-sm">삭제</button>
	...
	jQuery(document).ready(function() {
		...
		$("#divList").load("brochureList?&rowCount=${rowCount}&page=1", function(data) {});
    });
	...
	function search() {
		...
		var keyword = $('#keyword').val();
 		...
 		$("#divList").html('');
		$("#divList").load("brochureList?rowCount="+rowCount+"&regFromDate="+regFromDate+"&regToDate="+regToDate
	...
	function go_contents_add() {
		$.redirect( "brochureAdd", { }, "POST", "" );
	}
	</script>
  </body>
</html>