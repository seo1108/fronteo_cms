...
<!-- 	<div style="padding:10px;background-color:#d2d6de;">
 ...
 -->	
				...
				<c:forEach items="${data}" var="list" varStatus="status">
					<tr class="text-center">
						<th class="quiztable-content-center-white">
							<input type="checkbox" name="selected" value="${list.contentSeq}" class="form-check-input" />
						</th>
						...
						<td class="quiztable-content-center-white">
							<button class="btn btn-primary btn-sm" onclick="go_detail('${list.contentSeq}');">상세보기</button>
						</td>
					</tr>
				</c:forEach>
			</tbody>
	...
	<script type="text/javascript">
		...
		function go_detail(contentSeq) {
			$.redirect( "whitepaperAdd", { contentSeq : contentSeq, type : 'edit', contentType : 'W' }, "POST", "" );
		}
