...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <span class="f24">eDiscovery Book</span> 
          <span class="f14" style="padding-left:20px;">전체 eDiscovery Book</span> <span class="f14" style="color:blue;"><fmt:formatNumber value="${totalCnt}" pattern="#,###" /></span>
        </section>
        ...
        <section class="content">
        	...
        	<div class="row">
				<div class="col-xs-12">
					...
					<div>
						<button onclick="go_ebook_add();" class="btn bg-primary btn-sm">등록</button>
						<button onclick="delete_ebook();" class="btn btn-danger btn-sm">삭제</button>
	...
	jQuery(document).ready(function() {
		...
		$("#divList").load("edbookList?&rowCount=${rowCount}&page=1", function(data) {});
    });
	...
	function go_ebook_add() {
		$.redirect( "edbookAdd", { }, "POST", "" );
	}
	</script>
  </body>
</html>