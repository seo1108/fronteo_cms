...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <span class="f24">Event</span> 
          <span class="f14" style="padding-left:20px;">전체 Event</span> <span class="f14" style="color:blue;"><fmt:formatNumber value="${totalCnt}" pattern="#,###" /></span>
        </section>
	...
	jQuery(document).ready(function() {
		...
		$("#divList").load("eventList?&rowCount=${rowCount}&page=1", function(data) {});
    });
