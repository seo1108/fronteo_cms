        ...
        <section class="content">
        	...
        	<div class="row">
				<div class="col-xs-12">
					...
					<div>
						<button onclick="go_press_add();" class="btn bg-primary btn-sm">등록</button>
						<button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#ModalLong" onclick="">삭제</button>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content" style="width:400px;margin-left:200px;margin-top:200px;">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn bg-olive" data-dismiss="modal" onclick="">확인</button>
					</div>
				</div>
			</div>
		</div>
