...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <span class="f24">FAQs</span> 
          <span class="f14" style="padding-left:20px;">전체 FAQs</span> <span class="f14" style="color:blue;"><fmt:formatNumber value="${totalCnt}" pattern="#,###" /></span>
        </section>
	...
	jQuery(document).ready(function() {
		...
		$("#divList").load("faqList?&rowCount=${rowCount}&page=1", function(data) {});
    });
	...
	function search() {
		...
		var keyword = $('#keyword').val();
 		...
 		$("#divList").html('');
		$("#divList").load("faqList?rowCount="+rowCount+"&regFromDate="+regFromDate+"&regToDate="+regToDate
